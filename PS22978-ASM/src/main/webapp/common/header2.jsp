				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<div class="header__top__left">
							<ul>
								<li><i class="fa fa-envelope"></i> hello@colorlib.com</li> a
					...
					<div class="col-lg-6 col-md-6">
						<div class="header__top__right">
							...
							<div class="header__top__right__auth">
								...
								<c:if test="${isLogin}">
									<c:if test="${admin}">
										<a href="/admin/page" class="login-panel"><i
				...
				<div class="col-lg-6">
					<nav class="header__menu">
						<ul>
							...
							<li><a href="/admin/page">Blog</a></li>
				...
				<div class="col-lg-3">
					<div class="header__cart">
						<ul>
							...
							<li><a href="/home/cart"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
						</ul>
