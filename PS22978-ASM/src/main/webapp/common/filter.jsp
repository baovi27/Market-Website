	...
	<div class="sidebar">
		...
		<div class="sidebar__item">
			...
			<div class="filter__sort">
				...
				<a href="/product/sort?field=price">Highest to Lowest</a> <br>

				<a href="/product/asc?asc=price">Lowest to Highest </a>
		...
		<div class="sidebar__item">
			...
			<div class="sidebar__item__size">
				<label for="medium"> Medium <input type="radio" id="medium">
				</label>
			</div>
			<div class="sidebar__item__size">
